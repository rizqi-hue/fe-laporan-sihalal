...
export interface DataLPHProps {
    className?: string;
}

const DataLPH: FC<DataLPHProps> = ({ className = "" }) => {
    return (
        <div className={`nc-DataLPH ${className}`} data-nc-id="DataLPH">
            <Helmet>
                <title>Data LPH</title>
            </Helmet>
            <div className="container pt-10 text-2xl text-purple-900 font-bold">
                Data Lembaga Penyedia Halal
            </div>
            ...
            <div className="container mt-5">
                <ul className="text-sm font-medium text-center text-purple-900 rounded-lg flex flex-col lg:flex-row dark:divide-gray-700 dark:text-gray-400 pt-5">
                    ...
                    <li className="w-full">
                        <Link to="/datalph" className="inline-block border border-gray-200 p-4 w-full bg-white hover:text-gray-700 hover:bg-gray-50  dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700 shadow-lg">LPH</Link>
